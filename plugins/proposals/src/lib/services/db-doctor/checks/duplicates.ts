...
export const checkDuplicateNaturalIds = ({ db }: IDoctorCheckContext): IDoctorCheck => {
	...
	return checkCount('duplicate_natural_ids', count, `${count} duplicate natural IDs detected.`);
};
