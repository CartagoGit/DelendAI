 ...
 * that don't start with `docs/delendai/proposals/` (e.g. absolute or
 * relative-from-cwd).
 */
	...
	return [
		{
			...
			fix: `Move the file to docs/delendai/proposals/${expectedFolder}/ (or to docs/delendai/proposals/${expectedFolder}/<kind-subfolder>/ for terminal statuses), or update status to match its current folder.`,
		},
	];
};
