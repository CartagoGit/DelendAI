...
export const PROPOSALS_LAYOUT = {
	...
	files: {
		'index.json':
			'machine-readable registry, REGENERATED by sync_proposals at <cacheDir>/proposals/index.json (default .cache/mcp-vertex/proposals/index.json) — a cache artefact, never hand-edited and never stored inside this folder',
		'README.md':
