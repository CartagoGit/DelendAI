 ...
 * `IProposalFrontmatter`. The vocabulary is host-defined — delendai is
 ...
 * hosts that enumerate their tracks); without it, delendai stays agnostic
 ...
 *   - `knownTracks` omitted → delendai is track-agnostic: any non-empty
