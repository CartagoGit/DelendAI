...
- `mcp-vertex_proposals_proposal_get` — 2,582 B total, 2,375 B of it `outputSchema` (measured, see docs/mcp-vertex/TOKEN-BUDGETS.md)
- `mcp-vertex_proposals_close_slice` — 2,469 B total, 1,767 B of it `outputSchema` (measured, see docs/mcp-vertex/TOKEN-BUDGETS.md)
