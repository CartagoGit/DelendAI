...
import { evaluateParallelism } from '@delendai/proposals/lib/proposals/proposal-parallelism';
import type { IProposalParallelism } from '@delendai/proposals/lib/proposals/proposal-parallelism';
