...
describe('@delendai/proposals plugin', async () => {
	...
	it('namespaces tool registration by the context prefix', async () => {
		...
		expect(names).toEqual([
			...
			'work_proposals_db_status',
			'work_proposals_db_doctor',
			'work_proposals_db_reconcile',
			'work_proposals_db_rebuild',
			'work_proposals_db_verify',
			'work_proposals_db_diff',
			'work_proposals_conflicts',
			'work_proposals_db_quarantine_list',
			'work_proposals_db_quarantine_repair',
			'work_proposals_db_tombstones',
			'work_proposals_db_resurrect',
			'work_proposals_search',
			'work_proposals_compile_context',
			'work_proposals_summary_backfill',
		]);
	});
