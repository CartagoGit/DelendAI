 ...
 * (`docs/delendai/proposals/retired/issues/github#<n>-<slug>.md`).
 *
	...
	register: async (server) => {
		server.registerTool(
			`${options.namespacePrefix}_issues_ingest`,
			{
				...
				description:
					'REQUIRES proposals plugin. Idempotently persists a GitHub issue as a scaffold file under docs/delendai/proposals/retired/issues/. force:true re-fetches and rewrites.',
