			...
			knowledge: [
				{
					...
					body: [
						...
						`For mcp-vertex-owned errors or defects, use \`${ctx.namespacePrefix}_mcp_vertex_issue_create\`; it always posts to \`${REPOSITORY_SLUG}\` and ignores the consuming project's origin.`,
