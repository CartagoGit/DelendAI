			...
			knowledge: [
				{
					...
					body: [
						...
						`For delendai-owned errors or defects, use \`${ctx.namespacePrefix}_delendai_issue_create\`; it always posts to \`${REPOSITORY_SLUG}\` and ignores the consuming project's origin.`,
