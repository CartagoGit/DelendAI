...
// The `id` field stays under `IForgeReleaseSuccess` but is intentionally
// omitted here — the schema is `.strict()` and the service's `id` is
// surfaced through the typed envelope, not through the JSON contract.
