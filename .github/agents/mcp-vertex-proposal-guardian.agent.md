...
1. First call `mcp-vertex_overview` once per turn (tool: `mcp-vertex/mcp-vertex_overview`); it maps the server's tools/plugins and returns a `recommendedNextAction`.
