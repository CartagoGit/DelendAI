...
priority: P0
shipped-in:
    - 5413e3f8c # x00300 nodeDynamicImport deprecated
    - e74aab209 # x00305 proposals_close_plan outputSchema
    - 6a8a59aed # S2 consolidación posterior y registro en inventory
contains:
    proposals:
...
- **Status**: done
- **shipped-in**: 5413e3f8c, e74aab209
...
- [x] `nodeDynamicImport` aparece una vez en el inventory con madurez `deprecated`.
- [x] `proposals_close_plan` aparece en runtime con `outputSchema` y sus dos formas de exito validan.
- [x] Tests dirigidos, typecheck y build pasan.
- [x] Suite global no tiene los dos fallos observados.
- [x] Biome queda verde o cubierto por baseline ratchet explicito.
- [x] F-004 y F-005 tienen propuestas o quedan demostrablemente descartados.
- [x] No se atribuyen cambios de `x00298` a este plan.
