...
- **review-log**: approved by claude-opus5-orchestrator — Independent
  ...
  Checked against the real code instead: process-tree termination is live and covered by `packages/core/tests/src/lib/shared/process-tree-kill.spec.ts`, which spawns a real descendant and asserts it is reaped on abort; it passes.
