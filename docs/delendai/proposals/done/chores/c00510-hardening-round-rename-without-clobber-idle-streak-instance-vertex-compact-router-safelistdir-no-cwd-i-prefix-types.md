...
date: 2026-09-06
priority: P0
shipped_commit_sha: bc9a924a08e167d67c5d3ceabf17e4e3dd458f60
shipped_branch: develop
...
> **Status: shipped** in `bc9a924a0`. The five concrete outcomes below
> are implemented and tested; the follow-up slices (c00511, c00512,
> c00513, c00514, c00515, c00516-c00525) document the remaining work.
>
> **Post-commit retro (2026-09-06):** the reviewer's audit caught
> that two of the five outcomes were *partially* fixed:
> - `safeRename` has a multi-agent race window (fix: c00516).
> - `safeListDir` consumers discard `readFailed` (fix: c00517).
> Plus:
> - Windows containment in `scanAllProposalIds` (c00518).
> - Invalid filename / frontmatter still silently dropped (c00519).
> - `generated_at` pollutes `changed` (c00520).
> - Token benchmark needs hardening (c00521).
> - Bigger architectural plans (c00522-c00525) for Context Runtime.
