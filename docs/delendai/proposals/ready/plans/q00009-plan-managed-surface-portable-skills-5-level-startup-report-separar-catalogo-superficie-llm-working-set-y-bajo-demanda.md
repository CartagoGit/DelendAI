...
contains:
    proposals:
        ...
        - { id: d00015, kind: docs, required: true, priority: P1, track: docs,
            rationale: "Documentación de superficie: README §Surface modes, docs/delendai/SURFACE-MODES.md, ADOPTER-SURFACE-MODE.md, ejemplos de los 5 niveles de startup output, tabla before/after." }
...
source-spec:
    file: docs/delendai/specs/managed-surface-portable-skills-startup-report.md
    sections:
...
rollback-strategy: |
    ...
    `DELENDAI_SURFACE_DEFAULT` que se consulta en `decide-mode.ts`.
...
| `c00149` | chore | P1 | Migrar default silencioso `native → managed` con feature flag `DELENDAI_SURFACE_DEFAULT`; opt-out para hosts legacy; tests backwards compat. |
