...
contains:
    proposals:
        ...
        - { id: f00277, kind: feat, required: true, priority: P1, track: trust,
            rationale: "AgentSession + delendai agents: ver que hacen todos los agentes en worktrees sin cambiar de rama. AUD-G02." }
        ...
        - { id: f00280, kind: feat, required: true, priority: P1, track: adoption,
            rationale: "delendai adopt: descubrimiento en solo lectura + ProjectProfile + adopcion por etapas. En un repo grande el trabajo lo hace Vertex, no el usuario. AUD-G04." }
        ...
        - { id: f00274, kind: feat, required: false, priority: P2, track: product,
            rationale: "La extension VS Code se activa por comando: hoy no arranca en un repo sin delendai.config.json. AUD-F03." }
...
La auditoría independiente sobre `develop@2cf17373` concluye que delendai **no
...
> `f00198`/`f00199`; y `delendai adopt` (`AUD-G04`) y los subpaths del core
...
Relacionado: `docs/delendai/adr/0018-managed-lazy-loading-is-all-or-nothing.md`
