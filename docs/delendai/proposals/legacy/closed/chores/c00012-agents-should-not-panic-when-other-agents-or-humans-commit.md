...
ownership:
  ...
  - { agent: implementation_runner, task: 'S2: post f00057 refactor, move the canonical rule to docs/delendai/AGENT-BOOTSTRAP.md § 4.b and shrink the SKILL to a pointer + micro-pattern' }
...
This rule applies equally to: another `delendai` agent committing on
...
collapsed to single pointers to `docs/delendai/AGENT-BOOTSTRAP.md`.
...
- **Status**: done
- **Files**: `AGENTS.md`, `plugins/proposals/skills/multi-agent-coordination/SKILL.md`, `.github/copilot-instructions.md`, `docs/delendai/proposals/ready/c00012-agents-should-not-panic-on-peer-commits.md`
...
canonical rule into `docs/delendai/AGENT-BOOTSTRAP.md` § 4.b and
shrinks the SKILL to a pointer + micro-pattern. This makes the rule
survive any future compaction of the host-pointers.

- **Status**: done
- **Files**: `docs/delendai/AGENT-BOOTSTRAP.md`, `plugins/proposals/skills/multi-agent-coordination/SKILL.md`, `docs/delendai/proposals/ready/c00012-agents-should-not-panic-on-peer-commits.md`
...
- The five-point rule appears verbatim in
  `docs/delendai/AGENT-BOOTSTRAP.md` § 4.b.
- The new section in
  `plugins/proposals/skills/multi-agent-coordination/SKILL.md`
