...
- **Files**: `docs/delendai/proposals/ready/c00086-swarm-commit-discipline.md`
...
- On `develop`: any staged file under a "deep" path
  (`docs/delendai/proposals/`, `packages/*/src/`,
...
|---|---|---|---|
| S0 | Proposal | `docs/delendai/proposals/ready/c00086-swarm-commit-discipline.md` | — |
