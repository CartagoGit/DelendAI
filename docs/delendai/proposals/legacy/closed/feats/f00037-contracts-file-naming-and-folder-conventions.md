...
available to downstream `delendai` consumers as an opt-in TypeScript
...
- `delendai conventions check --profile=typescript`
- `delendai conventions plan --profile=typescript`
- `delendai conventions apply --profile=typescript --dry-run`
...
- [ ] The same rules are available as an opt-in TypeScript profile for
  consumer projects using `delendai`.
