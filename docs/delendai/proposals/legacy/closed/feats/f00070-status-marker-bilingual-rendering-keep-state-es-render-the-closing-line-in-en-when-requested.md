...
ownership:
    ...
    - { agent: implementation_runner, task: 'S5: update the `delendai-status-marker-and-closure` skill + `.github/copilot-instructions.md` table with the bilingual mapping; document that the validator tolerates both renderings' }
globalGate: validate
acceptance:
