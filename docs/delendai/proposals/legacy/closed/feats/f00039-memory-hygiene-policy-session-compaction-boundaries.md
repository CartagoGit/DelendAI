...
closed-evidence:
  - f00039 predates the shipped-in convention (pre-2026-07-24)
...
- **Files**: docs/scaffolds/ARCHITECTURE-MEMORY.md, docs/scaffolds/ARCHITECTURE-WORKFLOWS.md, .github/copilot-instructions.md, CLAUDE.md, skills/delendai-operator/SKILL.md
- **Status**: done
