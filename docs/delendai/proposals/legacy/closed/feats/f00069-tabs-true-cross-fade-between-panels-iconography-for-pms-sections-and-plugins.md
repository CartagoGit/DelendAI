...
- `apps/web/tests/lib/brand-logos.spec.ts` — new spec covering the
  three new kinds (S5).
- `docs/delendai/skills/tabs-component/SKILL.md` — new SKILL
  documenting the API.
...
- **Owner**: `implementation_runner`
- **Files**: `apps/web/src/lib/brand-logos.ts`, `apps/web/src/components/PluginDisclosure.astro`, `apps/web/src/components/PluginCapabilities.astro`, `apps/web/tests/lib/brand-logos.spec.ts` (new), `docs/delendai/skills/tabs-component/SKILL.md` (new — **deferred**, prescribed path is obsolete; see note)
...
- **Acceptance:**
  ...
  - `docs/delendai/skills/tabs-component/SKILL.md` documents the **unified** Tabs + brand-logo API: how to pick a tab variant, when to use `icon?`, how to call `brandLogo()` for any kind, and the rule "no hardcoded `/logos/...` strings — always go through `brandLogo()`".
...
- **Reconciliation note (2026-06-30):** the **code** half of S5 is already in
  ...
  - **SKILL.md is DEFERRED, not landed.** The prescribed path
    `docs/delendai/skills/tabs-component/SKILL.md` is **obsolete**: as of
    f00065 S1 (`docs/delendai/skills/README.md`), skills no longer live under
...
- `docs/delendai/skills/tabs-component/SKILL.md` documents the API.
