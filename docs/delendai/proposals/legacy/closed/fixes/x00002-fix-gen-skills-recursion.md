...
````text
skills/
  delendai-plugin-authoring/SKILL.md
  delendai-failure-modes/SKILL.md
````
...
2. **Pérdida silenciosa de información** — los dos SKILL.md ya
   escritos (`delendai-plugin-authoring`, `delendai-failure-modes`)
   no aparecen en el sitio, así que un visitante que llegue a
   `https://cartagogit.github.io/delendai/skills` (cuando esté
...
- [ ] `apps/web/src/data/skills.json` regenerado y contiene los 2
      SKILL.md con `path: "skills/delendai-…/SKILL.md"`.
