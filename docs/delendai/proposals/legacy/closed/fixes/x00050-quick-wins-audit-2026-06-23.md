...
- depends_on: [S1]
- acceptance:
    - "extensions/vscode/package.json declares activationEvents covering the contributed delendai views (e.g. `onView:delendai.*`), replacing the empty array at line 19"
