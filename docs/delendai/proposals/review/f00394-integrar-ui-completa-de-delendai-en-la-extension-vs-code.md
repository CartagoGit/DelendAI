...
Convertir la extension de VS Code en una aplicacion usable con la UI compartida de DelendAI como shell principal, todos los datos reales del workspace y acciones funcionales, manteniendo los arboles nativos solo como compatibilidad secundaria.

## why

La extension ya monta un dashboard compartido parcial, pero Memory, detalles de tools y propuestas, configuracion, agentes, knowledge y acciones siguen fragmentados en webviews o vistas nativas. La experiencia visible no representa aun el producto UI completo definido para DelendAI.
