...
- **Status**: pending
- **Files**: `packages/core/tests/src/lib/e2e/token-budget.e2e.spec.ts`, `docs/delendai/TOKEN-BUDGETS.md`
...
- **Status**: pending
- **Files**: `tools/scripts/host/host-server.script.ts`, `docs/delendai/CROSS-IDE.md`, `docs/delendai/CROSS-PROJECT-SETUP.md`
...
- **Status**: pending
- **Files**: `config/metrics-baseline.json`, `docs/delendai/AGENT-BOOTSTRAP.md`
