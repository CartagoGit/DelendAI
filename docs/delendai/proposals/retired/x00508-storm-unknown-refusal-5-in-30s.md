...
superseded-by: x00507
---

# x00508 — Storm UNKNOWN_REFUSAL: 5× in 30s

> **SUPERSEDED por `x00507`.**
> Esta copia retirada conserva el rastro del auto-repair anterior, pero la
> propuesta activa que debe investigarse es `x00507`.
