...
> `docs/delendai/proposals/done/` wins.
...
- [`02-our-infrastructure.md`](02-our-infrastructure.md) — what `delendai` already has today
...
- [`claude-code.md`](external/claude.md) (renamed f00500 S4)
- [`codex-cli.md`](external/codex.md) (renamed f00500 S4)
