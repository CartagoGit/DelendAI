...
rules behind the delendai KPI capability (`@delendai/project-kpis`). It
...
The delendai repository is the first dogfood target: `bun run --cwd
...
- CLI: `delendai kpis <view> [--json] [--watch] [--threshold=...]`
- VS Code: the Project KPIs view (`delendai.kpis`).
