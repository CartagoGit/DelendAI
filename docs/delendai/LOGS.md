...
The `@delendai/logs` plugin persists an append-only JSONL event log under
`.cache/delendai/results/logs/<YYYY-MM-DD>.jsonl`.
...
```json
{
  ...
  "kind": "tool-completed",
  "agent": null,
  "taskId": "delendai_overview",
  "outcome": "ok",
  "files": [],
  "summary": "tool-completed: delendai_overview",
  "meta": {}
}
```
