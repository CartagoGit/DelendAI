...
| `api` | `@delendai/api` | REST/GraphQL API surface for delendai plugins. | index |
...
| `error-reporting` | `@delendai/error-reporting` | Automatic delendai error reporting: opens de-duplicated GitHub issues for internal failures (enabled by default). | index |
