 ...
 * delendai contract (registers a tool + knowledge, and the tool produces the
...
const fakeContext = (
	...
	({
		...
		docsDir: 'docs/delendai',
		keepLegacy: false,
		pluginCacheDir: '.cache/delendai/example-wordcount',
		pluginDocsDir: 'docs/delendai/example-wordcount',
