...
> Generated 2026-08-31 from plugin manifests + the `lint:capabilities` static analysis. Regenerate with `bun tools/scripts/gen/capability-matrix.script.ts`.
