...
| env | public | * | env-read |
| error-reporting | public | * | network, forge-write |
| external-mcps | public | * | network, process |
| forge | public | * | forge-read, forge-write, network |
| git | public | * | git-read, git-write |
| i18n | public | * | filesystem-read |
| impact-analysis | public | * | filesystem-read |
| issues | public | * | forge-read, forge-write, network |
