...
> Owner: every contributor (human or agent) who edits `docs/mcp-vertex/**`.
...
`<!-- mcp-vertex:begin/end -->` comment blocks.**
...
- **Hybrid** — a manual prose section that contains one (and
  ...
  `<!-- mcp-vertex:begin ... -->` / `<!-- mcp-vertex:end ... -->`
...
[d00009](docs/mcp-vertex/security/capability-matrix.md) and
...
| Path                                              | Why                                                  |
| ------------------------------------------------- | ---------------------------------------------------- |
| `docs/mcp-vertex/AGENT-BOOTSTRAP.md`              | Agent-facing rules; subject to opinion and iteration. |
| `docs/mcp-vertex/ARCHITECTURE.md`                 | Layered narrative; explainer for newcomers.           |
| `docs/mcp-vertex/VISION-AND-OPERATING-MODEL.md`   | Strategic positioning; updated by the roadmap owner.  |
| `docs/mcp-vertex/decisions/**` (ADRs)             | Decisions and their rationale; forever frozen after adoption. |
...
| `docs/mcp-vertex/security/capability-matrix.md`         | [d00009] `gen:capability-matrix`          |
| `docs/mcp-vertex/TOKEN-BUDGETS.md`                      | `gen:token-budget-dashboard`              |
| `docs/mcp-vertex/generated/plugin-manifests.*`          | `gen:from-manifests`                      |
| `docs/mcp-vertex/plugins/auto-generated/*.md`           | `gen:plugin-docs`                         |
...
````markdown
<!-- mcp-vertex:begin <block-id> -->
... generated content ...
<!-- mcp-vertex:end <block-id> -->
````
