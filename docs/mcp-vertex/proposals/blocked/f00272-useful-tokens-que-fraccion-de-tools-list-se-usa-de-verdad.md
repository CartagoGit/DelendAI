...
**Lo que la auditoría no vio y este triage sí.** `docs/mcp-vertex/proposals/ready/feats/f00198-activation-precision-recall-churn.md`
...
`docs/mcp-vertex/proposals/ready/feats/f00199-tool-confusion-rate.md`
