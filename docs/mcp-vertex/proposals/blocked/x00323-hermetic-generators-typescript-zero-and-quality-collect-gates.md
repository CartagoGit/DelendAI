...
- **Status**: pending
- **Files**: `tools/scripts/gen`, `tools/scripts/lint`, `packages/core/tests/src/lib/cli`, `docs/mcp-vertex`
- **Gate**: type
- acceptance:
