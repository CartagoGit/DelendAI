...
> `docs/mcp-vertex/adr/0009-rail-lint-architecture.md` +
> `docs/mcp-vertex/adr/0010-rail-scaffold-strategy.md` +
> `docs/mcp-vertex/AGENT-BOOTSTRAP.md §6`.
>
...
- **Files (expected):**
  - `docs/mcp-vertex/adr/0008-rail-api-design.md`
  - `docs/mcp-vertex/adr/0009-rail-lint-architecture.md`
  - `docs/mcp-vertex/adr/0010-rail-scaffold-strategy.md`
  - `docs/mcp-vertex/AGENT-BOOTSTRAP.md` (sección 6 actualizada)
- **Acceptance:**
