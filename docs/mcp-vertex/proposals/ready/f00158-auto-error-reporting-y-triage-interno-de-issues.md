...
- acceptance:
  ...
  - "Desduplica por firma: el mismo error no crea issues duplicadas en la ventana configurada."
...
- Tests unitarios cubren firma/desdupe, construcción de body, análisis y aviso de máquina.
