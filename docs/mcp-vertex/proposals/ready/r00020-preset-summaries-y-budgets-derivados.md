...
- **Status**: pending
- **Files**: `packages/presets/src/lib/derive-summary.ts`, `packages/presets/src/lib/derive-budget.ts`
- **Gate**: type
- acceptance:
...
- **Status**: pending
- **Files**: `packages/presets/tests/src/derive.spec.ts`, `docs/mcp-vertex/presets.md`
- **Gate**: type
- acceptance:
  - "Tests verdes."
