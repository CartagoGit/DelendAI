---
id: a00055
title: "15-07-2026 claude-code fable-5 follow-up audit — the error-envelope class made a convention, and gates that run in the wrong place"
kind: audit
status: done
type: proposal
track: audit
...
- **Status**: done
- **Files**: `docs/mcp-vertex/proposals/ready/a00055-15-07-2026-claude-code-fable-5-follow-up-audit-the-error-envelope-class-made-a-convention-and-gates-that-run-in-the-wrong-place.md`
- **Gate**: lint
- acceptance:
