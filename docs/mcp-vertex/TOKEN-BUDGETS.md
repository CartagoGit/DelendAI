...
Generated at: 2026-08-30T01:28:19.718Z
...
| agent_catalog full | native | 9,516 | 2379 | 8,500 | 9,000 | over hard (9,000B) |
...
| logs_tail | native | 2,334 | 584 | 5,500 | 6,000 | within hard |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| minimal | minimal | native | managed | tokens-gate | 2 | 37 | 49,436 | 12359 | 41,600 | 3,343 | 12,982 | 28,618 | 5,065 | 1,090 | n/a | within hard | within hard | none |
...
| lean | lean | native | managed | tokens-gate | 4 | 49 | 60,017 | 15005 | 49,960 | 4,077 | 16,246 | 33,714 | 8,221 | 1,307 | n/a | within hard | within hard | none |
| lean | lean | adaptive | managed | dynamic-client | 4 | 6 | 4,900 | 1225 | 3,656 | 526 | 1,020 | 2,636 | 0 | 567 | n/a | within hard | within hard | none |
| standard | standard | native | managed | tokens-gate | 19 | 99 | 119,845 | 29962 | 98,726 | 8,666 | 28,500 | 70,226 | 10,007 | 2,865 | n/a | within hard | over warning (9,500B) | none |
...
| swarm | swarm | native | managed | tokens-gate | 27 | 165 | 191,670 | 47918 | 156,231 | 14,535 | 46,673 | 109,558 | 48,550 | 4,477 | 153 | within hard | within hard | none |
| swarm | swarm | adaptive | managed | dynamic-client | 27 | 6 | 4,900 | 1225 | 3,656 | 526 | 1,020 | 2,636 | 0 | 858 | n/a | within hard | within hard | none |
| full | full | native | managed | tokens-gate | 31 | 172 | 200,352 | 50088 | 163,566 | 15,014 | 49,735 | 113,831 | 48,550 | 4,815 | 153 | within hard | within hard | none |
| full | full | adaptive | managed | dynamic-client | 31 | 6 | 4,900 | 1225 | 3,656 | 526 | 1,020 | 2,636 | 0 | 899 | n/a | within hard | within hard | none |
| vertex | vertex | native | managed | tokens-gate | 37 | 193 | 252,458 | 63115 | 209,329 | 18,306 | 56,809 | 152,520 | 48,550 | 5,700 | 153 | within hard | within hard | none |
...
| web-app | web-app | native | managed | tokens-gate | 18 | 89 | 104,303 | 26076 | 85,793 | 7,390 | 25,582 | 60,211 | 8,221 | 2,738 | n/a | n/a | n/a | none |
| web-app | web-app | adaptive | managed | dynamic-client | 18 | 6 | 4,900 | 1225 | 3,656 | 526 | 1,020 | 2,636 | 0 | 727 | n/a | n/a | n/a | none |
| backend-api | backend-api | native | managed | tokens-gate | 16 | 88 | 102,719 | 25680 | 84,402 | 7,347 | 25,561 | 58,841 | 8,221 | 2,602 | n/a | n/a | n/a | none |
| backend-api | backend-api | adaptive | managed | dynamic-client | 16 | 6 | 4,900 | 1225 | 3,656 | 526 | 1,020 | 2,636 | 0 | 703 | n/a | n/a | n/a | none |
| cli-tool | cli-tool | native | managed | tokens-gate | 7 | 56 | 69,078 | 17270 | 57,456 | 4,764 | 18,035 | 39,421 | 8,221 | 1,538 | n/a | n/a | n/a | none |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| minimal | native | managed | tokens-gate | core | 28 | 42,584 | 2,836 | 11,457 | 24,899 | 0 | 756 | 1,904 | 86.2% |
...
| lean | native | managed | tokens-gate | core | 28 | 42,584 | 2,836 | 11,457 | 24,899 | 0 | 756 | 1,904 | 71.0% |
...
| standard | native | managed | tokens-gate | core | 28 | 42,584 | 2,836 | 11,457 | 24,899 | 0 | 756 | 1,904 | 35.6% |
...
| swarm | native | managed | tokens-gate | core | 28 | 42,584 | 2,836 | 11,457 | 24,899 | 0 | 756 | 1,904 | 22.2% |
...
| full | native | managed | tokens-gate | core | 28 | 42,584 | 2,836 | 11,457 | 24,899 | 0 | 756 | 1,904 | 21.3% |
...
| vertex | native | managed | tokens-gate | core | 28 | 42,584 | 2,836 | 11,457 | 24,899 | 0 | 756 | 1,904 | 16.9% |
...
| web-app | native | managed | tokens-gate | core | 28 | 42,584 | 2,836 | 11,457 | 24,899 | 0 | 756 | 1,904 | 40.9% |
...
| backend-api | native | managed | tokens-gate | core | 28 | 42,584 | 2,836 | 11,457 | 24,899 | 0 | 756 | 1,904 | 41.5% |
...
| cli-tool | native | managed | tokens-gate | core | 28 | 42,584 | 2,836 | 11,457 | 24,899 | 0 | 756 | 1,904 | 61.7% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| minimal | native | managed | tokens-gate | 49,436 | 11612 | 11871 | 12359 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| minimal | adaptive | managed | dynamic-client | 4,900 | 1151 | 1187 | 1225 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| lean | native | managed | tokens-gate | 60,017 | 14173 | 14524 | 15005 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| lean | adaptive | managed | dynamic-client | 4,900 | 1151 | 1187 | 1225 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| standard | native | managed | tokens-gate | 119,845 | 28715 | 29390 | 29962 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| standard | adaptive | managed | dynamic-client | 4,900 | 1151 | 1187 | 1225 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| swarm | native | managed | tokens-gate | 191,670 | 46234 | 47315 | 47918 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| swarm | adaptive | managed | dynamic-client | 4,900 | 1151 | 1187 | 1225 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| full | native | managed | tokens-gate | 200,352 | 48390 | 49512 | 50088 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| full | adaptive | managed | dynamic-client | 4,900 | 1151 | 1187 | 1225 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| vertex | native | managed | tokens-gate | 252,458 | 60825 | 61897 | 63115 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| vertex | adaptive | managed | dynamic-client | 4,900 | 1151 | 1187 | 1225 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| web-app | native | managed | tokens-gate | 104,303 | 24894 | 25522 | 26076 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| web-app | adaptive | managed | dynamic-client | 4,900 | 1151 | 1187 | 1225 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| backend-api | native | managed | tokens-gate | 102,719 | 24480 | 25099 | 25680 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
...
| cli-tool | native | managed | tokens-gate | 69,078 | 16330 | 16723 | 17270 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
...
| --- | --- | --- | --- | --- | --- | --- |
| minimal | 4,900 | ok | — | 49,436 | ok | — |
| lean | 4,900 | ok | — | 60,017 | ok | — |
| standard | 4,900 | ok | — | 119,845 | ok | — |
| swarm | 4,900 | ok | — | 191,670 | ok | — |
| full | 4,900 | ok | — | 200,352 | ok | — |
| vertex | 4,900 | ok | — | 252,458 | ok | — |
| web-app | 4,900 | n/a | — | 104,303 | n/a | — |
| backend-api | 4,900 | n/a | — | 102,719 | n/a | — |
| cli-tool | 4,900 | n/a | — | 69,078 | n/a | — |
