...
| vertex | vertex | native | managed | tokens-gate | 38 | 179 | 228,354 | 57089 | 188,511 | 17,010 | 52,296 | 136,215 | 50,347 | 59 | 153 | within hard | within hard | adaptive-optimizer: could not load plugin "adaptive-optimizer" (tried @mcp-vertex/adaptive-optimizer, mcp-adaptive-optimizer, adaptive-optimizer). @mcp-vertex/adaptive-optimizer: Export named 'estimateResponseBytes' not found in module '/home/cartago/_projects/mcp-vertex/packages/core/src/lib/metrics/metrics-registry.ts'.; mcp-adaptive-optimizer: ResolveMessage: Cannot find package 'mcp-adaptive-optimizer' from '/home/cartago/_projects/mcp-vertex/packages/core/src/lib/plugins/load-plugins.ts'; adaptive-optimizer: ResolveMessage: Cannot find package 'adaptive-optimizer' from '/home/cartago/_projects/mcp-vertex/packages/core/src/lib/plugins/load-plugins.ts'<br>project-kpis: could not load plugin "project-kpis" (tried @mcp-vertex/project-kpis, mcp-project-kpis, project-kpis). @mcp-vertex/project-kpis: Export named 'estimateResponseBytes' not found in module '/home/cartago/_projects/mcp-vertex/packages/core/src/lib/metrics/metrics-registry.ts'.; mcp-project-kpis: ResolveMessage: Cannot find package 'mcp-project-kpis' from '/home/cartago/_projects/mcp-vertex/packages/core/src/lib/plugins/load-plugins.ts'; project-kpis: ResolveMessage: Cannot find package 'project-kpis' from '/home/cartago/_projects/mcp-vertex/packages/core/src/lib/plugins/load-plugins.ts'<br>usage-tracking: could not load plugin "usage-tracking" (tried @mcp-vertex/usage-tracking, mcp-usage-tracking, usage-tracking). @mcp-vertex/usage-tracking: Export named 'estimateResponseBytes' not found in module '/home/cartago/_projects/mcp-vertex/packages/core/src/lib/metrics/metrics-registry.ts'.; mcp-usage-tracking: ResolveMessage: Cannot find package 'mcp-usage-tracking' from '/home/cartago/_projects/mcp-vertex/packages/core/src/lib/plugins/load-plugins.ts'; usage-tracking: ResolveMessage: Cannot find package 'usage-tracking' from '/home/cartago/_projects/mcp-vertex/packages/core/src/lib/plugins/load-plugins.ts'<br>orchestrator-runner: plugin "orchestrator-runner" requires "usage-tracking" (not in load set) |
| vertex | vertex | adaptive | managed | dynamic-client | 38 | 6 | 4,900 | 1225 | 3,656 | 526 | 1,020 | 2,636 | 0 | 56 | n/a | within hard | within hard | adaptive-optimizer: could not load plugin "adaptive-optimizer" from "@mcp-vertex/adaptive-optimizer": Export named 'estimateResponseBytes' not found in module '/home/cartago/_projects/mcp-vertex/packages/core/src/lib/metrics/metrics-registry.ts'.<br>project-kpis: could not load plugin "project-kpis" from "@mcp-vertex/project-kpis": Export named 'estimateResponseBytes' not found in module '/home/cartago/_projects/mcp-vertex/packages/core/src/lib/metrics/metrics-registry.ts'.<br>usage-tracking: could not load plugin "usage-tracking" from "@mcp-vertex/usage-tracking": Export named 'estimateResponseBytes' not found in module '/home/cartago/_projects/mcp-vertex/packages/core/src/lib/metrics/metrics-registry.ts'. |
...
| vertex | native | managed | tokens-gate | core | 28 | 42,739 | 2,839 | 11,533 | 24,975 | 0 | 756 | 1,904 | 18.7% |
| vertex | native | managed | tokens-gate | audit | 4 | 10,099 | 802 | 1,992 | 6,803 | 0 | 108 | 272 | 4.4% |
| vertex | native | managed | tokens-gate | auto-agent-selector | 5 | 7,327 | 620 | 1,377 | 4,633 | 0 | 135 | 340 | 3.2% |
| vertex | native | managed | tokens-gate | auto-plugin-selector | 1 | 3,827 | 154 | 1,227 | 2,300 | 0 | 27 | 68 | 1.7% |
| vertex | native | managed | tokens-gate | commit-policy | 5 | 6,866 | 665 | 1,060 | 4,433 | 0 | 135 | 324 | 3.0% |
...
| vertex | native | managed | tokens-gate | deps | 5 | 5,688 | 384 | 773 | 3,912 | 0 | 135 | 340 | 2.5% |
| vertex | native | managed | tokens-gate | diagram | 4 | 3,897 | 337 | 1,435 | 1,606 | 0 | 108 | 272 | 1.7% |
| vertex | native | managed | tokens-gate | docs | 3 | 2,348 | 181 | 527 | 1,272 | 0 | 81 | 204 | 1.0% |
| vertex | native | managed | tokens-gate | env | 2 | 3,628 | 227 | 650 | 2,506 | 0 | 54 | 136 | 1.6% |
| vertex | native | managed | tokens-gate | forge | 11 | 5,011 | 645 | 3,173 | 0 | 0 | 297 | 572 | 2.2% |
| vertex | native | managed | tokens-gate | git | 8 | 5,065 | 442 | 900 | 2,781 | 0 | 216 | 544 | 2.2% |
| vertex | native | managed | tokens-gate | i18n | 2 | 2,725 | 174 | 230 | 2,072 | 0 | 54 | 136 | 1.2% |
...
| vertex | native | managed | tokens-gate | quality-policy | 1 | 8,319 | 114 | 166 | 7,902 | 0 | 27 | 68 | 3.6% |
| vertex | native | managed | tokens-gate | link-check | 1 | 1,354 | 112 | 85 | 1,028 | 0 | 27 | 68 | 0.6% |
| vertex | native | managed | tokens-gate | logs | 9 | 7,718 | 710 | 3,016 | 2,908 | 0 | 243 | 612 | 3.4% |
| vertex | native | managed | tokens-gate | memory | 9 | 8,221 | 553 | 2,737 | 3,824 | 0 | 243 | 612 | 3.6% |
| vertex | native | managed | tokens-gate | notification | 2 | 1,592 | 196 | 291 | 840 | 0 | 54 | 136 | 0.7% |
| vertex | native | managed | tokens-gate | agent-orchestrator | 6 | 10,007 | 737 | 1,907 | 6,561 | 0 | 162 | 408 | 4.4% |
| vertex | native | managed | tokens-gate | perf | 3 | 3,872 | 281 | 1,152 | 2,083 | 0 | 81 | 188 | 1.7% |
| vertex | native | managed | tokens-gate | proposals | 34 | 50,347 | 3,399 | 10,013 | 32,411 | 0 | 918 | 2,312 | 22.1% |
| vertex | native | managed | tokens-gate | quality | 4 | 1,902 | 294 | 550 | 536 | 0 | 108 | 272 | 0.8% |
| vertex | native | managed | tokens-gate | rules | 3 | 5,856 | 263 | 520 | 4,700 | 0 | 81 | 204 | 2.6% |
| vertex | native | managed | tokens-gate | search | 1 | 1,873 | 65 | 687 | 1,000 | 0 | 27 | 68 | 0.8% |
| vertex | native | managed | tokens-gate | security | 4 | 5,857 | 370 | 810 | 4,153 | 0 | 108 | 272 | 2.6% |
...
| vertex | native | managed | tokens-gate | test-convention | 3 | 3,406 | 289 | 689 | 2,015 | 0 | 81 | 204 | 1.5% |
...
| vertex | native | managed | tokens-gate | 228,354 | 54955 | 56027 | 57089 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
