...
Generated at: 2026-08-30T15:36:48.576Z
...
| overview full (native) | native | 12,631 | 3158 | 12,300 | 12,650 | over warning (12,300B) |
| overview compact (native) | native | 1,790 | 448 | 1,750 | 1,800 | over warning (1,750B) |
...
| agent_catalog full | native | 9,519 | 2380 | 9,800 | 10,500 | within hard |
...
| logs_tail | native | 2,634 | 659 | 5,500 | 6,000 | within hard |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| minimal | minimal | native | managed | tokens-gate | 2 | 37 | 49,563 | 12391 | 41,724 | 3,346 | 13,044 | 28,680 | 5,065 | 1,090 | n/a | within hard | within hard | none |
...
| lean | lean | native | managed | tokens-gate | 4 | 49 | 60,144 | 15036 | 50,084 | 4,080 | 16,308 | 33,776 | 8,221 | 1,307 | n/a | within hard | within hard | none |
| lean | lean | adaptive | managed | dynamic-client | 4 | 6 | 4,900 | 1225 | 3,656 | 526 | 1,020 | 2,636 | 0 | 567 | n/a | within hard | within hard | none |
| standard | standard | native | managed | tokens-gate | 19 | 99 | 120,219 | 30055 | 99,097 | 8,669 | 28,685 | 70,412 | 10,007 | 2,865 | n/a | within hard | over warning (9,500B) | none |
...
| swarm | swarm | native | managed | tokens-gate | 27 | 165 | 193,589 | 48398 | 158,132 | 14,553 | 47,230 | 110,902 | 49,282 | 4,477 | 153 | within hard | within hard | none |
| swarm | swarm | adaptive | managed | dynamic-client | 27 | 6 | 4,900 | 1225 | 3,656 | 526 | 1,020 | 2,636 | 0 | 858 | n/a | within hard | within hard | none |
| full | full | native | managed | tokens-gate | 31 | 172 | 202,271 | 50568 | 165,467 | 15,032 | 50,292 | 115,175 | 49,282 | 4,815 | 153 | within hard | within hard | none |
| full | full | adaptive | managed | dynamic-client | 31 | 6 | 4,900 | 1225 | 3,656 | 526 | 1,020 | 2,636 | 0 | 899 | n/a | within hard | within hard | none |
| vertex | vertex | native | managed | tokens-gate | 38 | 195 | 266,150 | 66538 | 222,525 | 18,506 | 58,890 | 163,635 | 49,282 | 5,804 | 153 | within hard | within hard | none |
| vertex | vertex | adaptive | managed | dynamic-client | 38 | 6 | 4,900 | 1225 | 3,656 | 526 | 1,020 | 2,636 | 0 | 1,045 | n/a | within hard | within hard | none |
| web-app | web-app | native | managed | tokens-gate | 18 | 89 | 104,677 | 26170 | 86,164 | 7,393 | 25,767 | 60,397 | 8,221 | 2,738 | n/a | n/a | n/a | none |
| web-app | web-app | adaptive | managed | dynamic-client | 18 | 6 | 4,900 | 1225 | 3,656 | 526 | 1,020 | 2,636 | 0 | 727 | n/a | n/a | n/a | none |
| backend-api | backend-api | native | managed | tokens-gate | 16 | 88 | 103,093 | 25774 | 84,773 | 7,350 | 25,746 | 59,027 | 8,221 | 2,602 | n/a | n/a | n/a | none |
| backend-api | backend-api | adaptive | managed | dynamic-client | 16 | 6 | 4,900 | 1225 | 3,656 | 526 | 1,020 | 2,636 | 0 | 703 | n/a | n/a | n/a | none |
| cli-tool | cli-tool | native | managed | tokens-gate | 7 | 56 | 69,205 | 17302 | 57,580 | 4,767 | 18,097 | 39,483 | 8,221 | 1,538 | n/a | n/a | n/a | none |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| minimal | native | managed | tokens-gate | core | 28 | 42,587 | 2,839 | 11,457 | 24,899 | 0 | 756 | 1,904 | 86.0% |
...
| lean | native | managed | tokens-gate | core | 28 | 42,587 | 2,839 | 11,457 | 24,899 | 0 | 756 | 1,904 | 70.9% |
...
| lean | native | managed | tokens-gate | memory | 9 | 8,221 | 553 | 2,737 | 3,824 | 0 | 243 | 612 | 13.7% |
...
| standard | native | managed | tokens-gate | core | 28 | 42,587 | 2,839 | 11,457 | 24,899 | 0 | 756 | 1,904 | 35.5% |
...
| standard | native | managed | tokens-gate | memory | 9 | 8,221 | 553 | 2,737 | 3,824 | 0 | 243 | 612 | 6.8% |
...
| standard | native | managed | tokens-gate | quality | 4 | 3,901 | 294 | 550 | 2,535 | 0 | 108 | 272 | 3.2% |
...
| standard | native | managed | tokens-gate | env | 2 | 3,250 | 227 | 272 | 2,506 | 0 | 54 | 136 | 2.7% |
...
| swarm | native | managed | tokens-gate | core | 28 | 42,587 | 2,839 | 11,457 | 24,899 | 0 | 756 | 1,904 | 22.0% |
...
| swarm | native | managed | tokens-gate | memory | 9 | 8,221 | 553 | 2,737 | 3,824 | 0 | 243 | 612 | 4.3% |
...
| swarm | native | managed | tokens-gate | proposals | 34 | 49,282 | 3,364 | 9,960 | 31,434 | 0 | 918 | 2,312 | 25.5% |
...
| full | native | managed | tokens-gate | core | 28 | 42,587 | 2,839 | 11,457 | 24,899 | 0 | 756 | 1,904 | 21.1% |
| full | native | managed | tokens-gate | git | 8 | 5,065 | 442 | 900 | 2,781 | 0 | 216 | 544 | 2.5% |
| full | native | managed | tokens-gate | search | 1 | 1,873 | 65 | 687 | 1,000 | 0 | 27 | 68 | 0.9% |
| full | native | managed | tokens-gate | memory | 9 | 8,221 | 553 | 2,737 | 3,824 | 0 | 243 | 612 | 4.1% |
...
| full | native | managed | tokens-gate | proposals | 34 | 49,282 | 3,364 | 9,960 | 31,434 | 0 | 918 | 2,312 | 24.4% |
...
| vertex | native | managed | tokens-gate | core | 28 | 42,587 | 2,839 | 11,457 | 24,899 | 0 | 756 | 1,904 | 16.0% |
...
| vertex | native | managed | tokens-gate | auto-agent-selector | 5 | 7,327 | 620 | 1,377 | 4,633 | 0 | 135 | 340 | 2.8% |
| vertex | native | managed | tokens-gate | auto-plugin-selector | 1 | 3,827 | 154 | 1,227 | 2,300 | 0 | 27 | 68 | 1.4% |
| vertex | native | managed | tokens-gate | commit-policy | 5 | 6,626 | 665 | 1,060 | 4,193 | 0 | 135 | 324 | 2.5% |
| vertex | native | managed | tokens-gate | completion | 3 | 2,612 | 396 | 704 | 1,129 | 0 | 81 | 204 | 1.0% |
| vertex | native | managed | tokens-gate | container | 5 | 3,489 | 580 | 1,627 | 687 | 0 | 135 | 276 | 1.3% |
...
| vertex | native | managed | tokens-gate | deps | 5 | 5,688 | 384 | 773 | 3,912 | 0 | 135 | 340 | 2.1% |
...
| vertex | native | managed | tokens-gate | forge | 10 | 4,519 | 568 | 2,879 | 0 | 0 | 270 | 520 | 1.7% |
| vertex | native | managed | tokens-gate | git | 8 | 5,065 | 442 | 900 | 2,781 | 0 | 216 | 544 | 1.9% |
...
| vertex | native | managed | tokens-gate | quality-policy | 1 | 8,319 | 114 | 166 | 7,902 | 0 | 27 | 68 | 3.1% |
| vertex | native | managed | tokens-gate | link-check | 1 | 1,354 | 112 | 85 | 1,028 | 0 | 27 | 68 | 0.5% |
| vertex | native | managed | tokens-gate | logs | 9 | 7,718 | 710 | 3,016 | 2,908 | 0 | 243 | 612 | 2.9% |
| vertex | native | managed | tokens-gate | memory | 9 | 8,221 | 553 | 2,737 | 3,824 | 0 | 243 | 612 | 3.1% |
| vertex | native | managed | tokens-gate | notification | 2 | 1,592 | 196 | 291 | 840 | 0 | 54 | 136 | 0.6% |
| vertex | native | managed | tokens-gate | orchestrator-runner | 11 | 14,202 | 1,028 | 4,012 | 7,595 | 0 | 297 | 748 | 5.3% |
...
| vertex | native | managed | tokens-gate | proposals | 34 | 49,282 | 3,364 | 9,960 | 31,434 | 0 | 918 | 2,312 | 18.5% |
| vertex | native | managed | tokens-gate | project-kpis | 1 | 9,898 | 118 | 1,129 | 8,518 | 0 | 27 | 68 | 3.7% |
| vertex | native | managed | tokens-gate | quality | 4 | 3,901 | 294 | 550 | 2,535 | 0 | 108 | 272 | 1.5% |
...
| vertex | native | managed | tokens-gate | security | 4 | 5,857 | 370 | 810 | 4,153 | 0 | 108 | 272 | 2.2% |
...
| vertex | native | managed | tokens-gate | usage-tracking | 3 | 10,729 | 235 | 978 | 9,109 | 0 | 81 | 204 | 4.0% |
...
| web-app | native | managed | tokens-gate | core | 28 | 42,587 | 2,839 | 11,457 | 24,899 | 0 | 756 | 1,904 | 40.7% |
| web-app | native | managed | tokens-gate | git | 8 | 5,065 | 442 | 900 | 2,781 | 0 | 216 | 544 | 4.8% |
| web-app | native | managed | tokens-gate | search | 1 | 1,873 | 65 | 687 | 1,000 | 0 | 27 | 68 | 1.8% |
| web-app | native | managed | tokens-gate | memory | 9 | 8,221 | 553 | 2,737 | 3,824 | 0 | 243 | 612 | 7.9% |
| web-app | native | managed | tokens-gate | docs | 3 | 2,348 | 181 | 527 | 1,272 | 0 | 81 | 204 | 2.2% |
| web-app | native | managed | tokens-gate | i18n | 2 | 2,725 | 174 | 230 | 2,072 | 0 | 54 | 136 | 2.6% |
| web-app | native | managed | tokens-gate | rules | 3 | 5,856 | 263 | 520 | 4,700 | 0 | 81 | 204 | 5.6% |
| web-app | native | managed | tokens-gate | quality | 4 | 3,901 | 294 | 550 | 2,535 | 0 | 108 | 272 | 3.7% |
| web-app | native | managed | tokens-gate | refactor | 6 | 7,152 | 319 | 2,116 | 3,916 | 0 | 162 | 408 | 6.8% |
| web-app | native | managed | tokens-gate | deps | 5 | 5,688 | 384 | 773 | 3,912 | 0 | 135 | 340 | 5.4% |
| web-app | native | managed | tokens-gate | test-policy | 2 | 1,932 | 179 | 365 | 1,118 | 0 | 54 | 136 | 1.8% |
| web-app | native | managed | tokens-gate | test-convention | 3 | 3,406 | 289 | 689 | 2,015 | 0 | 81 | 204 | 3.3% |
| web-app | native | managed | tokens-gate | diagram | 4 | 3,897 | 337 | 1,435 | 1,606 | 0 | 108 | 272 | 3.7% |
| web-app | native | managed | tokens-gate | env | 2 | 3,250 | 227 | 272 | 2,506 | 0 | 54 | 136 | 3.1% |
| web-app | native | managed | tokens-gate | container | 5 | 3,489 | 580 | 1,627 | 687 | 0 | 135 | 276 | 3.3% |
...
| backend-api | native | managed | tokens-gate | core | 28 | 42,587 | 2,839 | 11,457 | 24,899 | 0 | 756 | 1,904 | 41.3% |
| backend-api | native | managed | tokens-gate | git | 8 | 5,065 | 442 | 900 | 2,781 | 0 | 216 | 544 | 4.9% |
| backend-api | native | managed | tokens-gate | search | 1 | 1,873 | 65 | 687 | 1,000 | 0 | 27 | 68 | 1.8% |
| backend-api | native | managed | tokens-gate | memory | 9 | 8,221 | 553 | 2,737 | 3,824 | 0 | 243 | 612 | 8.0% |
...
| backend-api | native | managed | tokens-gate | quality | 4 | 3,901 | 294 | 550 | 2,535 | 0 | 108 | 272 | 3.8% |
| backend-api | native | managed | tokens-gate | refactor | 6 | 7,152 | 319 | 2,116 | 3,916 | 0 | 162 | 408 | 6.9% |
| backend-api | native | managed | tokens-gate | deps | 5 | 5,688 | 384 | 773 | 3,912 | 0 | 135 | 340 | 5.5% |
...
| backend-api | native | managed | tokens-gate | database | 5 | 4,339 | 398 | 1,091 | 2,256 | 0 | 135 | 308 | 4.2% |
| backend-api | native | managed | tokens-gate | diagram | 4 | 3,897 | 337 | 1,435 | 1,606 | 0 | 108 | 272 | 3.8% |
| backend-api | native | managed | tokens-gate | env | 2 | 3,250 | 227 | 272 | 2,506 | 0 | 54 | 136 | 3.2% |
...
| cli-tool | native | managed | tokens-gate | core | 28 | 42,587 | 2,839 | 11,457 | 24,899 | 0 | 756 | 1,904 | 61.6% |
...
| cli-tool | native | managed | tokens-gate | memory | 9 | 8,221 | 553 | 2,737 | 3,824 | 0 | 243 | 612 | 11.9% |
| cli-tool | native | managed | tokens-gate | docs | 3 | 2,348 | 181 | 527 | 1,272 | 0 | 81 | 204 | 3.4% |
| cli-tool | native | managed | tokens-gate | env | 2 | 3,250 | 227 | 272 | 2,506 | 0 | 54 | 136 | 4.7% |
...
| mcp-vertex_adopt_project | core | 3,474 | 26 | 141 | 331 | 2,881 | 0 | 27 | 68 |
| mcp-vertex_usage-tracking_session_hygiene | usage-tracking | 3,345 | 43 | 71 | 146 | 2,990 | 0 | 27 | 68 |
| mcp-vertex_commit-policy_commit_policy_status | commit-policy | 3,227 | 47 | 153 | 85 | 2,847 | 0 | 27 | 68 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| minimal | native | managed | tokens-gate | 49,563 | 11642 | 11901 | 12391 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| minimal | adaptive | managed | dynamic-client | 4,900 | 1151 | 1187 | 1225 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| lean | native | managed | tokens-gate | 60,144 | 14203 | 14554 | 15036 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| lean | adaptive | managed | dynamic-client | 4,900 | 1151 | 1187 | 1225 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| standard | native | managed | tokens-gate | 120,219 | 28805 | 29480 | 30055 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| standard | adaptive | managed | dynamic-client | 4,900 | 1151 | 1187 | 1225 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| swarm | native | managed | tokens-gate | 193,589 | 46696 | 47774 | 48398 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| swarm | adaptive | managed | dynamic-client | 4,900 | 1151 | 1187 | 1225 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| full | native | managed | tokens-gate | 202,271 | 48852 | 49971 | 50568 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| full | adaptive | managed | dynamic-client | 4,900 | 1151 | 1187 | 1225 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| vertex | native | managed | tokens-gate | 266,150 | 64126 | 65192 | 66538 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| vertex | adaptive | managed | dynamic-client | 4,900 | 1151 | 1187 | 1225 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| web-app | native | managed | tokens-gate | 104,677 | 24984 | 25612 | 26170 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| web-app | adaptive | managed | dynamic-client | 4,900 | 1151 | 1187 | 1225 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
| backend-api | native | managed | tokens-gate | 103,093 | 24570 | 25189 | 25774 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
...
| cli-tool | native | managed | tokens-gate | 69,205 | 16360 | 16753 | 17302 | measured-real-bpe, measured-legacy-bpe, estimated-byte-ratio |
...
| --- | --- | --- | --- | --- | --- | --- |
| minimal | 4,900 | ok | — | 49,563 | ok | — |
| lean | 4,900 | ok | — | 60,144 | ok | — |
| standard | 4,900 | ok | — | 120,219 | ok | — |
| swarm | 4,900 | ok | — | 193,589 | ok | — |
| full | 4,900 | ok | — | 202,271 | ok | — |
| vertex | 4,900 | ok | — | 266,150 | ok | — |
| web-app | 4,900 | n/a | — | 104,677 | n/a | — |
| backend-api | 4,900 | n/a | — | 103,093 | n/a | — |
| cli-tool | 4,900 | n/a | — | 69,205 | n/a | — |
