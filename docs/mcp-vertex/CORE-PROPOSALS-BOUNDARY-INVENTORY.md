...
| packages/core/src/lib/setup/setup-steps.ts | mcp-vertex --plugins=proposals,issues | plugin-name | adapter | 1 | El comando sugerido fija el nombre del plugin proposals en el core. |
