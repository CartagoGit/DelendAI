...
[`docs/mcp-vertex/AGENT-BOOTSTRAP.md`](../AGENT-BOOTSTRAP.md). The canonical first move is
...
> in [`docs/mcp-vertex/AGENT-BOOTSTRAP.md`](../AGENT-BOOTSTRAP.md). Host files reference that
