 ...
 * components) covers `.delendai-header`, `.delendai-dropdown`, `.delendai-toast`,
 * `.delendai-disclosure`, `.delendai-lang-picker` etc.; this module fills the
 ...
 *     in `--delendai-brand-*`; everything else delegates to the host.
 ...
 * keeps the contract single-string and zero-runtime-fetch.
 */
export declare const dashboardCss: string;
