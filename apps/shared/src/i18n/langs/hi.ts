// filepath: apps/shared/src/i18n/langs/hi.ts
//
// S2 — merged language dictionary for `hi`. Site section lifted
// from apps/web/src/i18n/langs/hi.ts with the proposals/recovery/logs
// references inlined from apps/web/src/i18n/{proposals,logs}.ts. Extension
// section lifted from extensions/vscode/src/i18n/langs/hi.ts. Tools
...
const site = {
	...
	install: {
		...
		lead: 'इसे जोड़ें और अपने MCP क्लाइंट को delendai बाइनरी की ओर इंगित करें:',
		verify: 'चलता है यह जाँचें',
		addto: 'अपने IDE / एजेंट में जोड़ें',
		presets: 'प्रीसेट:',
		oneCmd: 'एक कमांड · कोई भी IDE',
		oneCmdNote:
			'आपका IDE पहचानकर delendai जोड़ता है — आपके बाकी MCP सर्वर को छुए बिना।',
		...
		faqA3: 'नहीं — एक सर्वर, एक प्रीसेट। यदि प्रति-प्रोजेक्ट अलग प्लगइन सेट चाहिए, तो उस प्रोजेक्ट में `delendai.config.json` रखें और लोडर उसे पहले पढ़ेगा।',
	},
	tools: {
		title: 'टूल',
...
const extension = {
	...
	openLogsToday: 'delendai: आज का लॉग खोलें',
	gitStatus: 'delendai: Git स्थिति',
	openMemory: 'delendai: मेमोरी खोज खोलें',
	notificationTest: 'delendai: सूचना का परीक्षण करें',
	depsCheck: 'delendai: निर्भरताएँ जाँचें',
	webFetch: 'delendai: वेब प्राप्त करें',
	...
	setupGithub: 'delendai: GitHub issues सेट अप करें',
};
...
const dev = {
	...
	firstRunHeading: 'delendai में आपका स्वागत है',
	firstRunLede:
		'यह एक्सटेंशन delendai MCP सर्वर के लिए डैशबोर्ड, सेटिंग्स और टूल पैनल प्रदान करता है। MCP सर्वर अभी इस वर्कस्पेस में इंस्टॉल नहीं हुआ है — एक बार इंस्टॉल होने पर, डैशबोर्ड वास्तविक डेटा लाने पर स्विच हो जाएगा।',
	firstRunSkip: 'छोड़ें — फिर भी डैशबोर्ड दिखाएँ',
	firstRunInstall: 'इस वर्कस्पेस में delendai इंस्टॉल करें',
};
