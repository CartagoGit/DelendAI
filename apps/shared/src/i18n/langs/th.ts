...
const site = {
	...
	install: {
		title: 'ติดตั้งและรัน',
		lead: 'เพิ่มมันแล้วชี้ไคลเอนต์ MCP ของคุณไปที่ไบนารี delendai:',
		verify: 'ตรวจว่ารันได้',
		addto: 'เพิ่มลงใน IDE / เอเจนต์ของคุณ',
		presets: 'พรีเซ็ต:',
		oneCmd: 'คำสั่งเดียว · ทุก IDE',
		oneCmdNote:
			'ตรวจจับ IDE ของคุณและเพิ่ม delendai — โดยไม่แตะเซิร์ฟเวอร์ MCP อื่นของคุณ',
		...
		faqQ1: 'ทำไม `deno run -A npm:@delendai/cli` เริ่มต้นช้า?',
		...
		faqA3: 'ไม่ได้ — หนึ่งเซิร์ฟเวอร์ หนึ่งพรีเซ็ต หากต้องการชุดปลั๊กอินต่างกันต่อโปรเจกต์ ให้วาง `delendai.config.json` ในโปรเจกต์นั้น แล้วตัวโหลดจะอ่านมันก่อน',
	},
	tools: {
		title: 'เครื่องมือ',
...
const extension = {
	...
	openLogsToday: 'delendai: เปิดบันทึกของวันนี้',
	gitStatus: 'delendai: สถานะ Git',
	openMemory: 'delendai: เปิดการค้นหาหน่วยความจำ',
	notificationTest: 'delendai: ทดสอบการแจ้งเตือน',
	depsCheck: 'delendai: ตรวจสอบการพึ่งพา',
	webFetch: 'delendai: ดึงเว็บ',
	...
	setupGithub: 'delendai: ตั้งค่า GitHub issues',
};
...
const dev = {
	...
	firstRunHeading: 'ยินดีต้อนรับสู่ delendai',
	firstRunLede:
		'ส่วนขยายนี้มีแดชบอร์ด การตั้งค่า และแผงเครื่องมือสำหรับเซิร์ฟเวอร์ MCP ของ delendai เซิร์ฟเวอร์ MCP ยังไม่ได้ติดตั้งในพื้นที่ทำงานนี้ — เมื่อติดตั้งแล้ว แดชบอร์ดจะเปลี่ยนไปดึงข้อมูลจริง',
	firstRunSkip: 'ข้าม — แสดงแดชบอร์ดต่อไป',
	firstRunInstall: 'ติดตั้ง delendai ในพื้นที่ทำงานนี้',
};
