...
const site = {
	...
	install: {
		...
		lead: 'Hinzufügen und den MCP-Client auf das delendai-Binary zeigen lassen:',
		verify: 'Prüfen, dass er startet',
		addto: 'Zu deinem IDE / Agent hinzufügen',
		presets: 'Presets:',
		oneCmd: 'Ein Befehl · jedes IDE',
		oneCmdNote:
			'Erkennt dein IDE und fügt delendai hinzu — ohne deine anderen MCP-Server anzurühren.',
		...
		faqQ1: 'Warum startet `deno run -A npm:@delendai/cli` langsam?',
		...
		faqA3: 'Nein — ein Server, ein Preset. Wenn du pro Projekt unterschiedliche Plugin-Sets brauchst, lege eine `delendai.config.json` im Projekt ab und der Loader liest sie zuerst.',
	},
	tools: {
		title: 'Tools',
...
const extension = {
	...
	a11yCloseToast: 'Schließen',
	a11yLanguageSelector: 'Sprache',
	overviewTitle: 'delendai Ubersicht',
	refresh: 'delendai: Aktualisieren',
	runValidation: 'delendai: Validierung ausfuhren',
	openProposalBoard: 'delendai: Vorschlagstafel offnen',
	showMetrics: 'delendai: Metriken anzeigen',
	toolsView: 'delendai Werkzeuge',
	proposalsView: 'delendai Vorschlage',
	statusTooltip: 'delendai Status',
	openDashboard: 'delendai: Dashboard offnen',
	openDocs: 'delendai: Dokumentation offnen',
	...
	docsUrlRejected: 'delendai: Docs-URL abgelehnt',
	openKnowledge: 'delendai: Wissensnavigator offnen',
	toolSearch: 'delendai: Werkzeuge suchen',
	restartServer: 'delendai: MCP-Server neu starten',
	openSettings: 'delendai: Einstellungen offnen',
	memorySave: 'delendai: Speichernotiz sichern',
	memoryForget: 'delendai: Speichernotiz vergessen',
	tabHealth: 'Zustand',
	...
	serverRestartHint:
		'delendai: bitte Erweiterung neu laden, um den MCP-Server neu zu starten.',
	openLogsToday: 'delendai: Heutiges Log öffnen',
	gitStatus: 'delendai: Git-Status',
	openMemory: 'delendai: Memory-Suche öffnen',
	notificationTest: 'delendai: Benachrichtigung testen',
	depsCheck: 'delendai: Abhängigkeiten prüfen',
	webFetch: 'delendai: Web abrufen',
	toolbarCategoryProposals: 'Vorschläge',
	toolbarCategoryKnowledge: 'Wissen',
	toolbarCategoryLogs: 'Logs',
	toolbarCategoryDocs: 'Docs',
	toolbarCategoryQuality: 'Qualität',
	toolbarCategoryGit: 'Git',
	toolbarCategoryMemory: 'Memory',
	toolbarCategoryNotification: 'Benachrichtigungen',
	toolbarCategoryDeps: 'Abhängigkeiten',
	toolbarCategoryTools: 'Tools',
	setupGithub: 'delendai: GitHub-Issues einrichten',
};
...
const dev = {
	...
	firstRunHeading: 'Willkommen bei delendai',
	firstRunLede:
		'Diese Erweiterung liefert ein Dashboard, Einstellungen und ein Werkzeug-Panel für den delendai MCP-Server. Der MCP-Server ist in diesem Workspace noch nicht installiert — sobald er es ist, wechselt das Dashboard zum Abruf echter Daten.',
	firstRunSkip: 'Überspringen — Dashboard trotzdem zeigen',
	firstRunInstall: 'delendai in diesem Workspace installieren',
};
