...
const site = {
	...
	install: {
		...
		lead: 'أضفها ووجّه عميل MCP لديك إلى ثنائي delendai:',
		verify: 'تحقّق من أنه يعمل',
		addto: 'أضِفه إلى IDE / الوكيل',
		presets: 'إعدادات مسبقة:',
		oneCmd: 'أمر واحد · أي IDE',
		oneCmdNote:
			'يكتشف الـ IDE ويضيف delendai — دون المساس بخوادم MCP الأخرى لديك.',
		...
		faqA3: 'لا — خادم واحد، إعداد مسبق واحد. إذا احتجت مجموعات إضافات مختلفة لكل مشروع، ضع `delendai.config.json` في ذلك المشروع ويقرأه المُحمِّل أولًا.',
	},
	tools: {
		title: 'الأدوات',
...
const extension = {
	...
	a11yCloseToast: 'إغلاق',
	a11yLanguageSelector: 'اللغة',
	...
	openLogsToday: 'delendai: فتح سجل اليوم',
	gitStatus: 'delendai: حالة Git',
	openMemory: 'delendai: فتح بحث الذاكرة',
	notificationTest: 'delendai: اختبار الإشعار',
	depsCheck: 'delendai: فحص التبعيات',
	webFetch: 'delendai: جلب صفحة ويب',
	...
	setupGithub: 'delendai: إعداد issues الخاصة بـ GitHub',
};
...
const dev = {
	...
	firstRunHeading: 'مرحبًا بك في delendai',
	firstRunLede:
		'توفر هذه الإضافة لوحة تحكم وإعدادات ولوحة أدوات لخادم MCP الخاص بـ delendai. خادم MCP غير مثبت في مساحة العمل هذه بعد — بمجرد تثبيته، ستتحول لوحة التحكم إلى جلب البيانات الحقيقية منه.',
	firstRunSkip: 'تخطي — اعرض لوحة التحكم على أي حال',
	firstRunInstall: 'تثبيت delendai في مساحة العمل هذه',
};
