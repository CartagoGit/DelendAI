// filepath: apps/shared/src/i18n/langs/ja.ts
//
// S2 — merged language dictionary for `ja`. Site section lifted
// from apps/web/src/i18n/langs/ja.ts with the proposals/recovery/logs
// references inlined from apps/web/src/i18n/{proposals,logs}.ts. Extension
// section lifted from extensions/vscode/src/i18n/langs/ja.ts. Tools
