...
const site = {
	...
	install: {
		title: 'Cài đặt & chạy',
		lead: 'Thêm nó và trỏ client MCP của bạn tới binary delendai:',
		verify: 'Kiểm tra nó chạy',
		addto: 'Thêm vào IDE / tác tử của bạn',
		presets: 'Preset:',
		oneCmd: 'Một lệnh · mọi IDE',
		oneCmdNote:
			'Tự phát hiện IDE và thêm delendai — không đụng tới các MCP server khác của bạn.',
		...
		faqA3: 'Không — một server, một preset. Nếu mỗi dự án cần bộ plugin khác, đặt một `delendai.config.json` trong dự án đó và loader đọc nó trước.',
	},
	tools: {
		title: 'Công cụ',
...
const extension = {
	...
	overviewTitle: 'Tong quan delendai',
	refresh: 'delendai: Lam moi',
	runValidation: 'delendai: Chay kiem dinh',
	openProposalBoard: 'delendai: Mo bang de xuat',
	showMetrics: 'delendai: Hien thi chi so',
	toolsView: 'Cong cu delendai',
	proposalsView: 'De xuat delendai',
	statusTooltip: 'trang thai delendai',
	openDashboard: 'delendai: Mo bang dieu khien',
	openDocs: 'delendai: Mo tai lieu',
	...
	docsUrlRejected: 'delendai: URL tai lieu bi tu choi',
	openKnowledge: 'delendai: Mo bo duyet tri thuc',
	toolSearch: 'delendai: Tim cong cu',
	restartServer: 'delendai: Khoi dong lai may chu MCP',
	openSettings: 'delendai: Mo cai dat',
	memorySave: 'delendai: Luu ghi chu bo nho',
	memoryForget: 'delendai: Quen ghi chu bo nho',
	tabHealth: 'Suc khoe',
	...
	serverRestartHint:
		'delendai: vui long khoi dong lai tien ich de khoi dong lai may chu MCP.',
	openLogsToday: 'delendai: Mở nhật ký hôm nay',
	gitStatus: 'delendai: Trạng thái Git',
	openMemory: 'delendai: Mở tìm kiếm bộ nhớ',
	notificationTest: 'delendai: Kiểm tra thông báo',
	depsCheck: 'delendai: Kiểm tra phụ thuộc',
	webFetch: 'delendai: Lấy web',
	...
	setupGithub: 'delendai: Thiết lập issues GitHub',
};
...
const dev = {
	...
	firstRunHeading: 'Chào mừng đến với delendai',
	firstRunLede:
		'Tiện ích mở rộng này cung cấp bảng điều khiển, cài đặt và bảng công cụ cho máy chủ MCP của delendai. Máy chủ MCP chưa được cài đặt trong workspace này — khi được cài đặt, bảng điều khiển sẽ chuyển sang lấy dữ liệu thực.',
	firstRunSkip: 'Bỏ qua — vẫn hiển thị bảng điều khiển',
	firstRunInstall: 'Cài đặt delendai trong workspace này',
};
