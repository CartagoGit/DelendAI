...
// can import `@delendai/shared`, `@delendai/shared/styles`, and
// `@delendai/shared/i18n` the same way every other consumer does.
...
// MUST precede the bare package alias or `@delendai/shared/i18n` resolves
...
const WORKSPACE_ALIASES = {
	...
	'@delendai/shared/styles/dashboard/dashboard-css': resolve(
		REPO_ROOT,
		'apps/shared/src/styles/dashboard/dashboard-css.ts',
	),
	'@delendai/shared/styles/dev-preview-css': resolve(
		REPO_ROOT,
		'apps/shared/src/styles/dev-preview-css.ts',
	),
	'@delendai/shared/styles': SHARED_STYLES,
	'@delendai/shared/i18n': SHARED_I18N,
	'@delendai/shared/components': SHARED_COMPONENTS,
	'@delendai/shared': SHARED_PUBLIC,
	// c00088: apps/shared deep-imports browser-safe client contracts
	// (`@delendai/client/lib/contracts/…`, since 0264f2a8). The client
	...
	// `@delendai/client` alias if one is ever added (shadowing rule).
