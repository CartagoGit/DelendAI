...
const dict: LangDict = {
	...
	pluginpage: {
		...
		install: 'Instalación',
		profileTitle: 'Perfil',
		profileMaturity: 'Madurez',
		profilePresets: 'Presets',
		profilePermissions: 'Permisos',
		profileTokenBudget: 'Presupuesto de tokens',
		profileBudgetWarning: 'Umbral de aviso',
		profileBudgetHard: 'Límite duro',
		profileBudgetReleaseRelativePercent: 'Umbral relativo a release',
	...
	setup: {
		...
		lead: 'Integra delendai en cualquier repositorio y deja listo el plugin de issues de GitHub para ese repo: los mismos 7 pasos que ejecuta el comando setup-github.',
		...
		writeConfigBody:
			'Escribe plugins.issues.options.repo en delendai.config.json sin tocar otros ajustes de plugins.',
	...
	homeQuickInstall: {
		...
		pms: [
			...
			{
				id: 'pnpm',
				note: 'Rápido, eficiente en disco, resolución estricta de dependencias.',
			},
			{ id: 'yarn', note: 'Alternativa clásica a npm.' },
			{
				id: 'bun',
				note: 'Runtime + gestor de paquetes todo-en-uno — delendai está hecho con bun.',
			},
			{
				id: 'deno',
				note: 'Runtime seguro por defecto con TypeScript de primera clase.',
			},
		],
		...
		panels: [
			{
				...
				label: 'Plugins',
				summary:
					'Paquetes publicados. Carga solo lo que necesites; el núcleo se mantiene mínimo.',
				href: 'plugins',
			...
			},
			{
				...
				label: 'Herramientas',
				summary:
					'Todas las herramientas del set completo de plugins, agrupadas por namespace — del registro vivo.',
				href: 'tools',
			...
			},
			{
				...
				label: 'Benchmarks',
				summary:
					'La eficiencia de tokens es un invariante protegido — medido, no prometido.',
				href: 'benchmarks',
			...
			},
			{
				...
				label: 'Skills',
				summary:
					'Manuales de dominio que el agente puede cargar bajo demanda.',
				href: 'skills',
			...
			},
			{
				...
				label: 'Conocimiento',
				summary:
					'Documentos catalogados sobre los que el núcleo puede responder.',
				href: 'knowledge',
			...
			},
			{
				...
				label: 'Presets',
				summary:
					'Conjuntos de plugins preconfigurados para cualquier tamaño de workspace.',
				href: 'presets',
				icon: '/logos/plugin-search.svg',
			},
			{
				id: 'setup',
				label: 'Configuración entre proyectos',
				summary:
					'Integra delendai en cualquier repo y deja listo el plugin de issues.',
				href: 'setup',
	...
	cli: {
		title: 'Guía de CLI',
		description:
			'Cómo usar la CLI de delendai / @delendai/core: flags globales, grupos de comandos por plugin y flujos de trabajo comunes.',
	},
	guide: {
		title: 'Guía',
		description:
			'Una guía de detalles del proyecto @delendai/core: conceptos, instalación, configuración, plugins, quality gates, extensión y FAQ.',
		toc: [
			'1. Introducción',
			'2. Conceptos',
			'3. Instalación',
			'4. Configuración',
			'5. Plugins',
			'6. Herramientas / Prompts / Recursos / Conocimiento',
			'7. Skills',
			'8. i18n',
			'9. Quality gates y multi-lenguaje',
			'10. Extender delendai',
			'11. Presupuestos de tokens',
			'12. Transiciones de vista',
			'13. FAQ',
		],
	},
};
