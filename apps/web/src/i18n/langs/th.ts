...
const dict: LangDict = {
	...
	pluginpage: {
		...
		profileMaturity: 'ระดับความพร้อม',
		profilePresets: 'พรีเซ็ต',
		profilePermissions: 'สิทธิ์',
		profileTokenBudget: 'งบประมาณโทเค็น',
		profileBudgetWarning: 'เกณฑ์เตือน',
		profileBudgetHard: 'ขีดจำกัดสูงสุด',
		profileBudgetReleaseRelativePercent: 'เกณฑ์เทียบกับรีลีส',
		maturityStable: 'เสถียร',
		maturityExperimental: 'ทดลอง',
		permissionFilesystemRead: 'อ่านระบบไฟล์',
		tabInstall: 'ติดตั้ง',
		tabTools: 'เครื่องมือ',
	...
	guide: {
		...
		toc: [
			...
			'4. การกำหนดค่า',
			'5. ปลั๊กอิน',
			'6. เครื่องมือ / พรอมต์ / ทรัพยากร / ความรู้',
			'7. ทักษะ',
			'8. i18n',
