...
const dict: LangDict = {
	...
	pluginpage: {
		...
		profileMaturity: 'Maturità',
		profilePresets: 'Preset',
		profilePermissions: 'Permessi',
		profileTokenBudget: 'Budget di token',
		profileBudgetWarning: 'Soglia di avviso',
		profileBudgetHard: 'Limite rigido',
		profileBudgetReleaseRelativePercent: 'Soglia relativa alla release',
