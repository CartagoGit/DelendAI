...
const dict: LangDict = {
	...
	pluginpage: {
		...
		profileTitle: 'Profil',
		profileMaturity: 'Reifegrad',
		profilePresets: 'Presets',
		profilePermissions: 'Berechtigungen',
		profileTokenBudget: 'Token-Budget',
		profileBudgetWarning: 'Warnschwelle',
		profileBudgetHard: 'Hartes Limit',
		profileBudgetReleaseRelativePercent: 'Release-relativer Schwellenwert',
		maturityStable: 'Stabil',
		maturityExperimental: 'Experimentell',
	...
	cli: {
		title: 'CLI-Handbuch',
		description:
			'So steuern Sie die CLI mcpv / @mcp-vertex/core: globale Flags, Befehlsgruppen pro Plugin und gängige Workflows.',
	},
	guide: {
		title: 'Handbuch',
		description:
			'Eine detaillierte Anleitung zum Projekt @mcp-vertex/core: Konzepte, Installation, Konfiguration, Plugins, Qualitäts-Tore, Erweiterung, FAQ.',
		toc: [
			'1. Einführung',
			'2. Konzepte',
			'3. Installation',
			'4. Konfiguration',
			'5. Plugins',
			'6. Werkzeuge / Prompts / Ressourcen / Wissen',
			'7. Skills',
			'8. i18n',
