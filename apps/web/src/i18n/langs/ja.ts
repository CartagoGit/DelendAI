...
const dict: LangDict = {
	...
	pluginpage: {
		...
		profileTitle: 'プロファイル',
		profileMaturity: '成熟度',
		profilePresets: 'プリセット',
		profilePermissions: '権限',
		profileTokenBudget: 'トークン予算',
		profileBudgetWarning: '警告しきい値',
		profileBudgetHard: 'ハード上限',
		profileBudgetReleaseRelativePercent: 'リリース相対しきい値',
		maturityStable: '安定',
		maturityExperimental: '実験的',
		permissionFilesystemRead: 'ファイルシステム読み取り',
		tabInstall: 'インストール',
		tabTools: 'ツール',
		tabConfiguration: '設定',
		tabTutorial: 'チュートリアル',
	...
	homeQuickInstall: {
		...
		pms: [
			...
			{
				id: 'deno',
				note: 'デフォルトで安全なランタイムとファーストクラスの TypeScript。',
			},
		],
		recommended: '推奨',
		fullCta: '完全なインストール表',
	...
	cli: {
		title: 'CLI ガイド',
		description:
			'mcpv / @mcp-vertex/core CLIの操作方法：グローバルフラグ、プラグインごとのコマンドグループ、一般的なワークフロー。',
	},
	guide: {
		title: 'ガイド',
		description:
			'@mcp-vertex/core プロジェクトの詳細なウォークスルー：コンセプト、インストール、設定、プラグイン、品質ゲート、拡張方法、FAQ。',
		toc: [
			'1. はじめに',
			'2. コンセプト',
			'3. インストール',
