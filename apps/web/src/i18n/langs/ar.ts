...
const dict: LangDict = {
	...
	pluginpage: {
		...
		install: 'التثبيت',
		profileTitle: 'الملف',
		profileMaturity: 'درجة النضج',
		profilePresets: 'الإعدادات المسبقة',
		profilePermissions: 'الأذونات',
		profileTokenBudget: 'ميزانية الرموز',
		profileBudgetWarning: 'حد التحذير',
		profileBudgetHard: 'الحد الصارم',
		profileBudgetReleaseRelativePercent: 'حد نسبي للإصدار',
		maturityStable: 'مستقر',
		maturityExperimental: 'تجريبي',
		permissionFilesystemRead: 'قراءة نظام الملفات',
		tabInstall: 'التثبيت',
		tabTools: 'الأدوات',
