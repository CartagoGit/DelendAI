...
const dict: LangDict = {
	...
	pluginpage: {
		...
		install: 'Instalação',
		profileTitle: 'Perfil',
		profileMaturity: 'Maturidade',
		profilePresets: 'Presets',
		profilePermissions: 'Permissões',
		profileTokenBudget: 'Orçamento de tokens',
		profileBudgetWarning: 'Limite de aviso',
		profileBudgetHard: 'Limite rígido',
		profileBudgetReleaseRelativePercent: 'Limite relativo ao release',
		maturityStable: 'Estável',
		maturityExperimental: 'Experimental',
		permissionFilesystemRead: 'Leitura do sistema de arquivos',
	...
	setup: {
		...
		lead: 'Integre o delendai em qualquer repositório e deixe o plugin de issues do GitHub pronto para esse repo — os mesmos 7 passos que o comando setup-github executa.',
		...
		writeConfigBody:
			'Grava plugins.issues.options.repo em delendai.config.json sem tocar em outras configurações de plugins.',
	...
	homeQuickInstall: {
		...
		pms: [
			...
			{
				id: 'bun',
				note: 'Runtime + gestor de pacotes tudo-em-um — o delendai é construído com bun.',
			},
			{
				id: 'deno',
	...
	homeAtAGlance: {
		...
		panels: [
			...
			},
			{
				...
				summary:
					'Integre o delendai em qualquer repositório e prepare o plugin de issues.',
				href: 'setup',
	...
	cli: {
		title: 'Guia da CLI',
		description:
			'Como usar a CLI delendai / @delendai/core: flags globais, grupos de comandos por plugin e fluxos de trabalho comuns.',
	},
	guide: {
		title: 'Guia',
		description:
			'Um guia detalhado do projeto @delendai/core: conceitos, instalação, configuração, plugins, barreiras de qualidade, extensão, FAQ.',
		toc: [
			'1. Introdução',
			'2. Conceitos',
			'3. Instalação',
			'4. Configuração',
			'5. Plugins',
			'6. Ferramentas / Prompts / Recursos / Conhecimento',
			'7. Skills',
			'8. i18n',
			'9. Barreiras de qualidade e multi-idioma',
			'10. Estendendo o delendai',
			'11. Orçamentos de tokens',
			'12. Transições de visualização',
			'13. FAQ',
		],
	},
};
