...
const dict: LangDict = {
	...
	pluginpage: {
		...
		profileMaturity: 'परिपक्वता',
		profilePresets: 'प्रिसेट्स',
		profilePermissions: 'अनुमतियाँ',
		profileTokenBudget: 'टोकन बजट',
		profileBudgetWarning: 'चेतावनी सीमा',
		profileBudgetHard: 'कठोर सीमा',
		profileBudgetReleaseRelativePercent: 'रिलीज़-सापेक्ष सीमा',
		maturityStable: 'स्थिर',
		maturityExperimental: 'प्रायोगिक',
		permissionFilesystemRead: 'फाइल सिस्टम पढ़ना',
		tabInstall: 'इंस्टॉल',
		tabTools: 'टूल',
