...
const dict: LangDict = {
	...
	cli: {
		title: 'CLI गाइड',
		description:
			'mcpv / @mcp-vertex/core CLI को चलाने का तरीका: वैश्विक फ़्लैग, प्रति-प्लगइन कमांड समूह, और सामान्य वर्कफ़्लो।',
	},
	guide: {
		title: 'गाइड',
		description:
			'@mcp-vertex/core परियोजना का विस्तृत वॉकथ्रू: अवधारणाएं, इंस्टॉल, कॉन्फ़िगरेशन, प्लगइन्स, गुणवत्ता गेट्स, विस्तार, अक्सर पूछे जाने वाले प्रश्न।',
		toc: [
			'1. परिचय',
			'2. अवधारणाएं',
			'3. इंस्टॉल',
