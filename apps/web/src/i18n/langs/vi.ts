...
const dict: LangDict = {
	...
	pluginpage: {
		...
		install: 'Cài đặt',
		profileTitle: 'Hồ sơ',
		profileMaturity: 'Độ trưởng thành',
		profilePresets: 'Preset',
		profilePermissions: 'Quyền',
		profileTokenBudget: 'Ngân sách token',
		profileBudgetWarning: 'Ngưỡng cảnh báo',
		profileBudgetHard: 'Giới hạn cứng',
		profileBudgetReleaseRelativePercent: 'Ngưỡng theo release',
		maturityStable: 'Ổn định',
		maturityExperimental: 'Thử nghiệm',
		permissionFilesystemRead: 'Đọc hệ thống tệp',
		tabInstall: 'Cài đặt',
		tabTools: 'Công cụ',
	...
	guide: {
		title: 'Hướng dẫn',
		description:
			'Bản hướng dẫn chi tiết về dự án @delendai/core: các khái niệm, cài đặt, cấu hình, plugin, cổng chất lượng, mở rộng, câu hỏi thường gặp.',
		toc: [
			'1. Giới thiệu',
			'2. Khái niệm',
			'3. Cài đặt',
