...
const dict: LangDict = {
	...
	pluginpage: {
		...
		profileTitle: 'Profil',
		profileMaturity: 'Maturité',
		profilePresets: 'Presets',
		profilePermissions: 'Permissions',
		profileTokenBudget: 'Budget de tokens',
		profileBudgetWarning: 'Seuil d’alerte',
		profileBudgetHard: 'Limite stricte',
		profileBudgetReleaseRelativePercent: 'Seuil relatif à la release',
	...
	setup: {
		...
		lead: 'Intégrez delendai dans n’importe quel dépôt et préparez le plugin issues de GitHub pour ce dépôt — les mêmes 7 étapes que la commande setup-github.',
		...
		writeConfigBody:
			'Écrit plugins.issues.options.repo dans delendai.config.json sans toucher aux autres réglages de plugins.',
	...
	homeQuickInstall: {
		...
		pms: [
			...
			{
				id: 'bun',
				note: 'Runtime + gestionnaire de paquets tout-en-un — delendai est lui-même construit avec bun.',
			},
			{
				id: 'deno',
	...
	homeAtAGlance: {
		...
		panels: [
			...
			},
			{
				...
				summary:
					"Branchez delendai dans n'importe quel dépôt et préparez le plugin issues.",
				href: 'setup',
	...
	cli: {
		title: 'Guide CLI',
		description:
			'Comment piloter la CLI delendai / @delendai/core : drapeaux globaux, groupes de commandes par plugin et flux de travail courants.',
	},
	guide: {
		title: 'Guide',
		description:
			'Un guide détaillé du projet @delendai/core : concepts, installation, configuration, plugins, barrières de qualité, extension, FAQ.',
		toc: [
			'1. Introduction',
			'2. Concepts',
			'3. Installation',
