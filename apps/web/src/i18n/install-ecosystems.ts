...
const en: IInstallDummiesTranslations = {
	...
	dummies: {
		...
		deno: 'Deno runs npm packages directly. The -A flag grants the permissions the server needs; npm:@mcp-vertex/core names the package to fetch.',
...
const es: IInstallDummiesTranslations = {
	...
	dummies: {
		...
		deno: 'Deno ejecuta paquetes de npm directamente. El flag -A concede los permisos que el servidor necesita; npm:@mcp-vertex/core indica el paquete a descargar.',
