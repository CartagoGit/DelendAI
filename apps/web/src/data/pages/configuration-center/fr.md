...
description: Configurez les plugins mcp-vertex et consultez la provenance des artefacts depuis VS Code.
order: 2
...
Lancez **MCP Vertex: Open Configuration Center** dans VS Code et choisissez le projet si la fenêtre a plusieurs racines. Les sections couvrent les réglages généraux, plugins, fournisseurs, agents, compétences, prompts, ressources et connaissances, avec propriétaire et provenance.
