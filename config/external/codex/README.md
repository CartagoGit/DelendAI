...
connects Codex to the repository-local delendai server. That MCP connection
...
still sufficient to discover and use delendai capabilities.

Codex hooks can observe lifecycle events, including turn stop, but a hook is
not a license for delendai to restart a completed Codex response. This pack
