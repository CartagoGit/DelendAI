...
- `delendai_adopt_project` — 3,553 B total, 2,905 B of it `outputSchema` (measured, see docs/delendai/TOKEN-BUDGETS.md)
- `delendai_scaffold` — 2,446 B total, 732 B of it `outputSchema` (measured, see docs/delendai/TOKEN-BUDGETS.md)
