 ...
 *   `delendai_logs_subscribe` every `pollIntervalMs` (default 2s) until the
...
const TOOL_QUERY = 'delendai_logs_query';
const TOOL_TAIL = 'delendai_logs_tail';
const TOOL_SUBSCRIBE = 'delendai_logs_subscribe';
const TOOL_CORRELATE = 'delendai_logs_correlate';
const TOOL_REDACT_TEST = 'delendai_logs_redact_test';
...
export class LogsService {
	...
	/**
	 * Poll `delendai_logs_subscribe` every `pollIntervalMs` and yield new
