 ...
 * (S4 in f126). Calls `delendai_proposals_state_health`,
 * `delendai_proposals_proposal_stale_list` and `delendai_proposals_agent_names` and
...
const TOOL_STATE_HEALTH = 'delendai_proposals_state_health';
const TOOL_STALE_LIST = 'delendai_proposals_proposal_stale_list';
const TOOL_AGENT_NAMES = 'delendai_proposals_agent_names';
