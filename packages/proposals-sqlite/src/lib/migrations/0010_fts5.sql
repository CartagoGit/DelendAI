 ...
 * cannot drift from the source rows. A first-boot `INSERT INTO
 * proposals_fts(proposals_fts) VALUES('rebuild')` repopulates the
 * index from existing rows; the bootstrap path runs this when the
 * schema version advances past 10.
 */
