...
describe('completion (f00046 S10)', async () => {
	...
	}, // On a cold cache + parallel test load it can take ~1s — well above // (~30 commands) and emits a bash function with a long case branch. // The completion script generator walks the full command tree
