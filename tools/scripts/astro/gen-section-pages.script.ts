 ...
 * Each language gets: {lang}/tools.astro, {lang}/benchmarks.astro and
 * {lang}/plugins/index.astro.
 *
 * The {lang}/install.astro pages used to live here too, but f00055 S6
 * converted /install to a PageSpec: the canonical source is now
 * `apps/web/src/data/pages/install/<lang>.md` and the route is the
 * dynamic `[lang]/[page].astro` reader wired by
 * `apps/web/scripts/gen-pages.ts`. This script no longer generates
 * /install.
 *
 ...
 * files per language that the bash heredoc did, with tabs for indent and
...
const SECTION_COMPONENTS: ReadonlyArray<{
	...
	// /install is generated by apps/web/scripts/gen-pages.ts from the
	// markdown under apps/web/src/data/pages/install/ — see f00055 S6.
