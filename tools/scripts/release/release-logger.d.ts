 ...
 */
export declare const createConsoleLogger: () => IReleaseLogger;
/**
 ...
 */
export declare const createQuietLogger: () => IReleaseLogger;
/**
...
export declare const createRecordingLogger: () => IRecordingLogger;
